...
export default function Footer({ onScrollTo, onOpenTerms }: FooterProps) {
  return (
    <footer className="bg-slate-950 text-slate-350 py-12 px-4 sm:px-6 lg:px-8 border-t-2 border-black">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        ...
        {/* Legal Row */}
        <div className="border-t border-slate-800 pt-5 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 text-[11px] font-mono text-slate-500">
          <button
            onClick={onOpenTerms}
          ...
          <span>Sesiones de mentoría S/30 · Pago no reembolsable</span>
        </div>
